...
<html lang="en">
  <head>
    ...
    <link href="<?=PATH_CSS?>materialize.1.min.css" rel="stylesheet" media="screen" title="no title">
  ...
  <body>
    ...
    <script src="<?=PATH_JAVA?>materialize.1.min.js"></script>
    <script src="<?=PATH_JAVA?>moment.min.js"></script>
